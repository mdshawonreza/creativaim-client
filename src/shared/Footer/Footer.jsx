    ...
    return (
        <div>
            ...
            <footer className="footer px-10 pt-8 pb-5   bg-[#121f4a] text-white">
                ...
                <nav>
                    <div >
                        <header className="footer-title text-[#27ecdf]">CONTACT</header>
                        <h2>
                            <span className="font-bold">Email :</span> fahadshawon241@gmail.com
                        </h2>
                        <h2>
                            <span className="font-bold">Phone :</span> +880 123456789
                        </h2>
                    </div>
                    <div className="mt-6">
                        <header className="footer-title text-[#27ecdf]">Social</header>
            ...
            <div className="footer px-10 pt-8 pb-10 bg-[#121f4a] text-white flex justify-center  ">
                ...
                <p className="">Copyright © 2023 - All right reserved by UniHostel Hub Ltd</p>
